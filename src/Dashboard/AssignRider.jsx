...
import { FaMotorcycle, FaUser, FaPhone, FaMapMarkerAlt, FaClock, FaBox } from "react-icons/fa";
...
const AssignRider = () => {
    ...
    const { data: parcels = [], isLoading, error: parcelsError } = useQuery({
    ...
    const { mutateAsync: assignRider, isLoading: isAssigning } = useMutation({
        ...
        onError: (error) => {
            ...
            Swal.fire({
                ...
                text: error.response?.data?.message || "Failed to assign rider. Please try again.",
                confirmButtonText: "OK"
            });
        },
    });
    ...
    const openAssignModal = async (parcel) => {
        ...
        try {
            ...
            Swal.fire({
                ...
                text: error.response?.data?.message || "Unable to load available riders. Please try again.",
                confirmButtonText: "OK"
            });
        } finally {
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 border border-gray-100">
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-4xl font-bold text-gray-800 mb-2">Assign Rider</h1>
                            <p className="text-gray-600 text-lg">Manage parcel assignments to delivery riders</p>
                        </div>
                        <div className="flex items-center space-x-6">
                            ...
                            <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl p-4 text-white shadow-lg">
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <p className="text-sm font-medium opacity-90">Total Parcels</p>
                ...
                {isLoading ? (
                    ...
                    <div className="bg-white rounded-2xl shadow-xl p-12 text-center border border-red-200">
                        ...
                        <h3 className="text-xl font-semibold text-red-700 mb-2">Error Loading Parcels</h3>
                        <p className="text-red-500 mb-4">
                            {parcelsError.response?.data?.message || "Unable to load parcels. Please check your connection and try again."}
                        </p>
                        <button 
                    ...
                    <div className="bg-white rounded-2xl shadow-xl p-12 text-center border border-gray-100">
                        ...
                        <h3 className="text-xl font-semibold text-gray-700 mb-2">No Parcels Available</h3>
                        <p className="text-gray-500">No parcels are available for assignment at the moment.</p>
                    </div>
                ) : (
                    <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                        <div className="bg-gradient-to-r from-green-500 to-blue-600 p-6">
                            <h2 className="text-2xl font-bold text-white">Available Parcels</h2>
                            <p className="text-green-100">Click "Assign Rider" to assign a delivery rider</p>
                        </div>
                            ...
                            <table className="w-full">
                                ...
                                <tbody className="divide-y divide-gray-200">
                                    {parcels.map((parcel, index) => (
                                        <tr key={parcel._id} className={`hover:bg-gray-50 transition-colors duration-200 ${index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}`}>
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="text-sm text-gray-500">{parcel.type}</div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td className="px-6 py-4">
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="text-sm text-gray-600">
                                                    {new Date(parcel.creation_date).toLocaleDateString('en-US', {
                                                        year: 'numeric',
                                                        month: 'short',
                                                        day: 'numeric'
                                                    })}
                    ...
                    <div className="modal-box max-w-4xl bg-white rounded-2xl shadow-2xl border border-gray-100">
                        <div className="bg-gradient-to-r from-green-500 to-blue-600 -m-6 mb-6 p-6 rounded-t-2xl">
                            ...
                            <p className="text-green-100">
                                Parcel: <span className="font-semibold">{selectedParcel?.title}</span>
                            </p>
                        </div>
                        ...
                        {loadingRiders ? (
                            ...
                            <div className="text-center py-12">
                                ...
                                <h3 className="text-xl font-semibold text-gray-700 mb-2">No Available Riders</h3>
                                <p className="text-red-500">No riders are available in this district at the moment.</p>
                            </div>
                        ) : (
                            <div>
                                <div className="mb-4 p-4 bg-blue-50 rounded-lg">
                                    <p className="text-blue-700 font-medium">
                                        Found {riders.length} available rider(s) in {selectedParcel?.sender_center}
                                    </p>
                                </div>
                                
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-h-96 overflow-y-auto">
                                    {riders.map((rider) => (
                                        <div key={rider._id} className="bg-gray-50 rounded-xl p-4 hover:bg-gray-100 transition-colors duration-200">
                                            <div className="flex items-center justify-between">
                                                <div className="flex items-center space-x-3">
