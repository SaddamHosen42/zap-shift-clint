        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-lg text-gray-600">Track all your parcel delivery payments</p>
                    {payments?.length > 0 && (
                ...
                {payments?.length > 0 ? (
                                    ...
                                    <div className="flex items-start space-x-4">
                                        ...
                                        <div className="flex-1">
                                            <div className="flex items-center gap-3 mb-2">
                                                <h3 className="text-xl font-bold text-secondary">Payment #{index + 1}</h3>
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                                                <div>
                                                    ...
                                                    <span className="font-medium text-gray-800" title={payment.parcelId}>
                    ...
                    <div className="bg-white rounded-3xl shadow-xl p-12 border border-gray-200 text-center">
                        ...
                        <h3 className="text-2xl font-bold text-gray-600 mb-2">No Payment History</h3>
                        <p className="text-gray-500 mb-6">You haven't made any payments yet. Start by booking a parcel delivery!</p>
                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-lg font-bold text-purple-600">
                                        {payments.length > 0 ? formatDate(payments[0].paid_at_string).split(',')[0] : 'N/A'}
                                    </p>
                                </div>
