...
const PendingDeliveries = () => {
  ...
  const totalValue = parcels.reduce(
    (sum, parcel) => sum + Number(parcel.cost),
    0
  );
  ...
  const handleStatusUpdate = (parcel, newStatus) => {
    const statusConfig = {
      in_transit: {
        ...
        successMessage:
          "Parcel has been marked as picked up and is now in transit",
      },
      delivered: {
        ...
        successMessage:
          "Parcel has been successfully delivered to the customer",
      },
    };
    ...
    Swal.fire({
                    ...
                    <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4 mb-6 border border-white/20">
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center justify-between text-sm">
                                ...
                                <span class="font-mono text-white bg-white/20 px-2 py-1 rounded">${
                                  parcel.tracking_id
                                }</span>
                            </div>
                            <div class="flex items-center justify-between text-sm">
      ...
      customClass: {
        ...
        confirmButton:
          "rounded-xl px-8 py-4 font-bold text-lg shadow-lg hover:shadow-xl transition-all duration-300",
        cancelButton:
          "rounded-xl px-8 py-4 font-bold text-lg shadow-lg hover:shadow-xl transition-all duration-300",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {filteredParcels.length > 0 && (
          <div className="mt-6 text-center text-gray-600">
            Showing {filteredParcels.length} of {totalAssigned} assigned
            deliveries
            {(searchTerm || statusFilter !== "all") && (
