  ...
  const {
    ...
    queryFn: async () => {
      const res = await axiosSecure.get(
        `/trackings/${selectedParcel.tracking_id}`
      );
      return res.data;
    },
  });
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-50 to-pink-100">
        <div className="text-center bg-white p-8 rounded-2xl shadow-2xl max-w-md">
          ...
          <p className="text-gray-600 mb-6">
            Failed to load your parcels. Please check your connection.
          </p>
          <button
          ...
          {userParcels.length === 0 ? (
            <div className="bg-white rounded-2xl shadow-2xl p-12 text-center border border-gray-100">
              ...
              <p className="text-gray-600 text-lg mb-8">
                You haven't sent any parcels yet. Create your first parcel to
                start tracking!
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {userParcels.map((parcel) => (
                <div
                  key={parcel._id}
                  className="bg-white rounded-2xl shadow-2xl p-6 border border-gray-100 hover:shadow-3xl transition-all duration-300"
                >
                  {/* Parcel Header */}
                  ...
                  <div
                    ...
                    )} px-4 py-2 rounded-full border-2 mb-4`}
                  >
          ...
          {!isTrackingLoading &&
            ...
            trackingData.length === 0 && (
              <div className="bg-white rounded-2xl shadow-2xl p-12 text-center border border-gray-100">
                ...
                <p className="text-gray-600 text-lg mb-8">
                  Tracking information for this parcel is not available yet. It
                  may take a few minutes after booking.
                </p>
                <div className="space-y-3 text-sm text-gray-500 mb-8 bg-gray-50 p-4 rounded-lg">
                  <div className="flex items-center space-x-2">
                    <span className="text-blue-500">•</span>
                    <span>
                      Tracking updates will appear here once processing begins
                    </span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <span className="text-green-500">•</span>
                    <span>
                      You'll receive notifications for major status changes
                    </span>
                  </div>
                  <div className="flex items-center space-x-2">
            ...
            <div className="space-y-8">
                ...
                <div className="flex items-center space-x-4 mb-4">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-gray-800">
                      Tracking ID: {selectedParcel?.tracking_id}
                    </h3>
                  ...
                  <div className="space-y-8">
                    {trackingData.map((update, index) => (
                      ...
                      >
                        {/* Timeline Dot */}
                        <div
                          className={`relative z-10 w-12 h-12 bg-gradient-to-br ${
              ...
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl shadow-lg p-8 border border-blue-200">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 mb-6">
                    If you have any questions about your delivery or need
