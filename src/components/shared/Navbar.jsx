      ...
      <div className="drawer-content">
        ...
        <div className="navbar bg-base-100 shadow-sm mx-auto">
          <div className="navbar-start">
            ...
            <label htmlFor="mobile-drawer" className="btn btn-ghost lg:hidden drawer-button">
              <svg
              ...
              <div className="space-y-2">
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 5v0a2 2 0 012-2h4a2 2 0 012 2v0" />
                  </svg>
                  <span>Dashboard</span>
                </NavLink>
